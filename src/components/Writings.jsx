...
export default function Writings() {
  ...
  const writings = [
    ...
    {
      title: "Bayesian Imitation Learning with Uncertainty Propagation",
      type: "Research Paper",
      year: "2024",
    },
    {
      title: "Ethics in Surveillance Capitalism",
      type: "Reflection Essay",
      year: "2024",
    },
    {
      title: "Lessons in Software Safety",
      type: "Reflection Essay",
      year: "2024",
    },
    { title: "AI Ownership", type: "Reflection Essay", year: "2024" },
    {
      title: "Addressing Cyber Attacks",
      type: "Reflection Essay",
      year: "2024",
    },
      ...
      <section className="blog-section">
        <div className="container">
          <div className="section-title centered">
            ...
            <h2>Writings</h2>
            <p>
              Browse my academic papers, essays, reflections, reports and other
              literature.
            </p>
          </div>
