...
const blogImages = import.meta.glob("../assets/images/blog/*.{png,jpg,jpeg}", {
  eager: true,
});
...
export default function BlogSection({ blogs }) {
  ...
  const getTagStyle = (tag) =>
    tagStyles[tag] || { background: "#ececec", color: "#333" };
  return (
    <section id="blog" className="blog-section">
      <div className="container">
        <div className="section-title centered">
          ...
          <p>
            I share my two cents on the latest technology news, in-depth
            analysis and personal perspectives on industry trends.
          </p>
        </div>
              ...
              <article className="blog-card" key={blog.title}>
                ...
                <div className="card-content">
                  <div className="card-info">
                    <span className="tag" style={getTagStyle(blog.tag)}>
                      {blog.tag}
                    </span>
